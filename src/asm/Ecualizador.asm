...
procesar_ecualizador:
    ...
    mov rax, 1
    cvtsi2ss xmm14, rax         
    shufps xmm14, xmm14, 0x00    ;copiar 1.0 a los 4 slots del registro [1.0, 1.0, 1.0, 1.0]

    ; Generar -1.0 
    mov rax, -1
    cvtsi2ss xmm15, rax          
    shufps xmm15, xmm15, 0x00    ;[-1.0, -1.0, -1.0, -1.0]
...
.bucle_principal:
    ...
    mov r8, rdx                 ; Puntero a la estructura 
    mov rcx, 3                  ; Contador para la 3 vueltas del ciclo

.bucle_bandas:
    ; Cargar coeficientes y duplicarlos 
    movss xmm5, [r8]            ; b0
    shufps xmm5, xmm5, 0x00     ; [b0, b0, b0, b0]
    movss xmm6, [r8 + 4]        ; b1
    shufps xmm6, xmm6, 0x00     ; [b1, b1, b1, b1]
    movss xmm7, [r8 + 8]        ; b2
    shufps xmm7, xmm7, 0x00     ; [b2, b2, b2, b2]
    movss xmm8, [r8 + 12]       ; a1
    shufps xmm8, xmm8, 0x00     ; [a1, a1, a1, a1]
    movss xmm9, [r8 + 16]       ; a2
    shufps xmm9, xmm9, 0x00     ; [a2, a2, a2, a2]
